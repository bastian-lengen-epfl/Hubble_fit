...
def kappa_clipping(kappa: float, Cepheids: pd.DataFrame, Cepheids_Outliers: pd.DataFrame, SN: pd.DataFrame , galaxies: list, all_text: bool =False):
    # First iteration
    q, H_0, chi2, cov, y, L, sigma_H_0 = find_H0(Cepheids, SN, galaxies, all_text)
